...
import { ChevronDown, ChevronUp, Loader2, Sparkles, Link, Plus, Briefcase, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <Label htmlFor="job-title" className="text-base font-semibold text-gray-900 flex items-center gap-2">
        ...
        >
          <div className="flex items-center gap-3">
            <div className={cn(
              ...
              showOptional ? "bg-blue-500 text-white" : "bg-gray-200 text-gray-500 group-hover:bg-blue-100 group-hover:text-blue-600"
            )}>
              <Plus className={cn("h-4 w-4 transition-transform duration-300", showOptional && "rotate-45")} />
            </div>
            <span className={cn(
              "transition-colors duration-300",
              showOptional ? "text-blue-700" : "text-gray-600 group-hover:text-blue-600"
            )}>
          ...
          <div className="space-y-6 animate-in slide-in-from-top-4 duration-500">
            <Card className="p-5 bg-gradient-to-br from-blue-50/50 to-indigo-50/50 border border-blue-200/50 rounded-xl">
              ...
              <div className="space-y-3 mb-6">
                <Label htmlFor="job-link" className="text-sm font-semibold text-gray-700 flex items-center gap-2">
              ...
              <div className="space-y-3">
                ...
                {jobData.description && (
                  <div className="flex items-center gap-2 text-sm text-green-600">
                    <CheckCircle className="h-3 w-3" />
                    <span>Job description added ({jobData.description.split(' ').length} words)</span>
                  </div>
                )}
              </div>
            </Card>
              ...
              <div className="text-center">
                <div className="p-3 bg-white/20 backdrop-blur-sm rounded-xl">
                  ...
                  <p className="text-xs text-white/80">
                    {jobData.description ? "Using job description for detailed matching" : "Basic analysis mode"}
                  </p>
                </div>
              </div>
            ) : isAnalyzing ? (
      ...
      {showOptional && (
        <Card className="p-4 bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200/50 rounded-xl animate-in slide-in-from-bottom-2 duration-300">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-purple-700 leading-relaxed">
                Including the full job description helps our AI provide more targeted suggestions
                and identify specific skills to highlight in your resume.
              </p>
            </div>
          </div>
        </Card>
